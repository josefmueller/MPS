...
public class ModelsToResources {
  ...
  public ModelsToResources(ModelGenerationStatusManager genStatusManager, Iterable<SModel> models) {
  ...
  /**
   * 
   * @deprecated use {@link jetbrains.mps.smodel.resources.ModelsToResources#ModelsToResources(ModelGenerationStatusManager, Iterable<SModel>) } instead
   */
  @Deprecated
  public ModelsToResources(Iterable<SModel> models) {
    myGenStatusManager = ModelGenerationStatusManager.getInstance();
    this.models = models;
  }
  ...
  public Iterable<IResource> resources(boolean dirtyOnly) {
    ...
    if (dirtyOnly) {
      smds = ListSequence.fromListWithValues(new ArrayList<SModel>(), (Iterable<SModel>) myGenStatusManager.getModifiedModels(Sequence.fromIterable(smds).toListSequence()));
    }
