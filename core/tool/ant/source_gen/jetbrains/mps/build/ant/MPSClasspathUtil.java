...
public class MPSClasspathUtil {
  ...
  private static final String[] FORK_CLASSPATH = new String[]{"jdom.jar", "log4j.jar", "ecj-4.6.2.jar", "xstream-1.4.8.jar", "asm4-all.jar", "asm-all.jar", "ext/diffutils-1.2.1.jar", "junit-4.12.jar", "javac2.jar"};
