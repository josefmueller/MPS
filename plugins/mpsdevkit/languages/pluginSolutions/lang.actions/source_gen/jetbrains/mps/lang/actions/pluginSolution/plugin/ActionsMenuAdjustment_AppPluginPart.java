...
public class ActionsMenuAdjustment_AppPluginPart extends ApplicationPluginPart {
  ...
  public ActionsMenuAdjustment_AppPluginPart() {
  }
  @Override
  public void init() {
    CreateRootFilterEP.getInstance().addFilter(ActionsMenuAdjustment_AppPluginPart.this.mySouldBeRemovedCondition);
  }
  @Override
  public void dispose() {
    CreateRootFilterEP.getInstance().removeFilter(ActionsMenuAdjustment_AppPluginPart.this.mySouldBeRemovedCondition);
  }
}
