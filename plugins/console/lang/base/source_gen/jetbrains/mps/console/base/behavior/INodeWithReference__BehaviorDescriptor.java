...
public final class INodeWithReference__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static Runnable execute_id7oNS25df64x(@NotNull SNode __thisNode__, final MPSProject project) {
    final SNodeReference targetNode = SNodeOperations.getPointer(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0xde1ad86d6e504a02L, 0xb306d4d17f64c375L, 0x36ac6f29ae8c1fb5L, 0x4904fd89e74fc6fL, "target")));
    return new Runnable() {
      public void run() {
        project.getRepository().getModelAccess().executeCommand(new Runnable() {
          public void run() {
            SNode nodeToNavigate = targetNode.resolve(project.getRepository());
            if (nodeToNavigate != null) {
              NavigationSupport.getInstance().openNode(project, nodeToNavigate, true, (SNodeOperations.getParent(nodeToNavigate) != null));
            }
          }
        });
      }
