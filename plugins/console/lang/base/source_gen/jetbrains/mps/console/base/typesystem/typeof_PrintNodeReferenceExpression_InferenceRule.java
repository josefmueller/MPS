...
public class typeof_PrintNodeReferenceExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
    ...
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:ae7d1f20-2cfe-46ef-a88a-193353a8b62b(jetbrains.mps.console.base.typesystem)", "6852607286009511978", true), (SNode) _quotation_createNode_t5gmh8_a1a2a0a0a1(), true, false, _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_t5gmh8_a1a2a0a0a1() {
