...
/*package*/ class NewElementStrategyFactory {
  ...
  /*package*/ static TextStrategy createNewLineStrategy(SNode node, EditorContext editorContext, boolean selectNewLine, boolean isFirstPosition) {
    if (SNodeOperations.isInstanceOf(node, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word"))) {
      return new NewElementStrategyFactory.AddNewLineAndSplitWordStrategy(SNodeOperations.cast(node, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word")), editorContext, selectNewLine);
    } else {
  ...
  /*package*/ static TextStrategy createNewElementStrategy(SNode node, EditorContext editorContext, boolean isFirstPosition) {
    if (SNodeOperations.isInstanceOf(node, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word"))) {
      return new NewElementStrategyFactory.SplitWordStrategy(SNodeOperations.cast(node, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word")), editorContext, !(isFirstPosition));
    } else {
  ...
  private static class AddNewLineStrategy extends TextStrategy {
    ...
    /*package*/ void execute() {
      SNode currentSibling = SNodeOperations.cast(SNodeOperations.getNextSibling(myElement), MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35ee7L, "jetbrains.mps.lang.richText.structure.TextElement"));
      SNode newElement = createNewElement();
      SNode newLine = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x2331694e561af166L, "jetbrains.mps.lang.richText.structure.Line"));
      ...
      while (currentSibling != null) {
        SNode next = SNodeOperations.cast(SNodeOperations.getNextSibling(currentSibling), MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35ee7L, "jetbrains.mps.lang.richText.structure.TextElement"));
      ...
      SNodeOperations.insertNextSiblingChild((SNodeOperations.cast(SNodeOperations.getParent(myElement), MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x2331694e561af166L, "jetbrains.mps.lang.richText.structure.Line"))), newLine);
      if (mySelectNewLine) {
    ...
    protected SNode createNewElement() {
      if (myIncludeCurrentElement) {
        ...
        return SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word"));
      }
    }
  }
  private static class AddNewLineAndSplitWordStrategy extends NewElementStrategyFactory.AddNewLineStrategy {
    ...
    @Override
    /*package*/ void execute() {
      SPropertyOperations.set(SNodeOperations.cast(myElement, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word")), MetaAdapterFactory.getProperty(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, 0x229012ddae35f05L, "value"), mySplitter.getLeftText());
      super.execute();
    }
  ...
  private static class SplitWordStrategy extends NewElementStrategyFactory.AddNewWordStrategy {
    ...
    /*package*/ void execute() {
      if (myAddNext) {
        ...
        SPropertyOperations.set(SNodeOperations.cast(myElement, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word")), MetaAdapterFactory.getProperty(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, 0x229012ddae35f05L, "value"), mySplitter.getRightText());
      }
      super.execute();
    }
