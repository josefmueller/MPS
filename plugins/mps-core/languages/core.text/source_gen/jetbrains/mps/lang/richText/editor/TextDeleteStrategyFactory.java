...
/*package*/ class TextDeleteStrategyFactory {
  ...
  /*package*/ static TextStrategy createDeleteStrategy(SNode currentNode, EditorContext editorContext, boolean isForward) {
    SNode neighbour = SNodeOperations.cast(((isForward ? SNodeOperations.getNextSibling(currentNode) : SNodeOperations.getPrevSibling(currentNode))), MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35ee7L, "jetbrains.mps.lang.richText.structure.TextElement"));
    if (SNodeOperations.isInstanceOf(currentNode, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word")) && (neighbour != null)) {
      if (SNodeOperations.isInstanceOf(neighbour, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word"))) {
        return new TextDeleteStrategyFactory.GlueNeighbourWordStrategy(SNodeOperations.cast(currentNode, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word")), SNodeOperations.cast(neighbour, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word")), editorContext, isForward);
      } else if (isEmptyString(SPropertyOperations.getString(SNodeOperations.cast(currentNode, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word")), MetaAdapterFactory.getProperty(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, 0x229012ddae35f05L, "value")))) {
        return new TextDeleteStrategyFactory.DeleteEmptyWordStrategy(SNodeOperations.cast(currentNode, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word")), neighbour, editorContext, isForward);
      }
    }
    if ((neighbour != null)) {
      return new TextDeleteStrategyFactory.RemoveNeighbourStrategy(neighbour, editorContext, isForward);
    } else {
      SNode currentLine = SNodeOperations.cast(SNodeOperations.getParent(currentNode), MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x2331694e561af166L, "jetbrains.mps.lang.richText.structure.Line"));
      SNode neighbourLine = SNodeOperations.cast(((isForward ? SNodeOperations.getNextSibling(currentLine) : SNodeOperations.getPrevSibling(currentLine))), MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x2331694e561af166L, "jetbrains.mps.lang.richText.structure.Line"));
      if ((neighbourLine != null)) {
        ...
        return new TextDeleteStrategyFactory.RemoveWholeTextStrategy(SNodeOperations.cast(SNodeOperations.getParent(currentLine), MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x2331694e5619f411L, "jetbrains.mps.lang.richText.structure.Text")), editorContext, isForward);
      }
    }
  ...
  private static class RemoveLineStrategy extends TextDeleteStrategyFactory.TextDeleteStrategy {
    ...
    /*package*/ void execute() {
      ...
      if (SNodeOperations.isInstanceOf(edgeElement, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word")) && SNodeOperations.isInstanceOf(myCurrentNode, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word"))) {
