...
public class Word_ActionMap {
  ...
  public static class Word_ActionMap_INSERT extends AbstractCellAction {
    ...
    public void execute_internal(EditorContext editorContext, SNode node) {
      NewElementStrategyFactory.createNewLineStrategy(SNodeOperations.cast(node, MetaAdapterFactory.getConcept(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L, "jetbrains.mps.lang.richText.structure.Word")), editorContext, true, false).execute();
    }
  }
