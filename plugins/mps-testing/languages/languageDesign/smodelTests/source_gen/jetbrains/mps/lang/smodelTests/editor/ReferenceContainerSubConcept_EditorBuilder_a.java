      ...
      protected EditorCell createRefCell(EditorContext context, final SNode effectiveNode, SNode node) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new ReferenceContainerSubConcept_EditorBuilder_a.Inline_Builder_j13i3b_a1a1b0(getEditorContext(), myNode, effectiveNode).createCell();
          }
        }, effectiveNode, "root");
  ...
  private EditorCell createRefCell_j13i3b_b1b1a() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected EditorCell createRefCell(EditorContext context, final SNode effectiveNode, SNode node) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new ReferenceContainerSubConcept_EditorBuilder_a.Inline_Builder_j13i3b_a1b1b0(getEditorContext(), myNode, effectiveNode).createCell();
          }
  ...
  private EditorCell createRefCell_j13i3b_b2b1a() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
      ...
      protected EditorCell createRefCell(EditorContext context, final SNode effectiveNode, SNode node) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new ReferenceContainerSubConcept_EditorBuilder_a.Inline_Builder_j13i3b_a1c1b0(getEditorContext(), myNode, effectiveNode).createCell();
          }
