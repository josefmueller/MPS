...
/*package*/ class NodeErrorCheckOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_kzyi6r_a();
  }

  private EditorCell createCollection_kzyi6r_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_kzyi6r_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createComponent_kzyi6r_a0());
    editorCell.addEditorCell(createRefNode_kzyi6r_b0());
    if (SNodeAccessUtil.hasProperty(myNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"))) {
      editorCell.addEditorCell(createNonEmptyProperty_kzyi6r_c0());
    }
    return editorCell;
  }
  private EditorCell createComponent_kzyi6r_a0() {
  ...
  private EditorCell createRefNode_kzyi6r_b0() {
