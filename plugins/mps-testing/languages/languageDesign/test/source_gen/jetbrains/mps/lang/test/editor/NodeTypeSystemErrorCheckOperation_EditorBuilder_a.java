...
/*package*/ class NodeTypeSystemErrorCheckOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_v8czwo_a();
  }

  private EditorCell createCollection_v8czwo_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_v8czwo_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createComponent_v8czwo_a0());
    if (SNodeAccessUtil.hasProperty(myNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"))) {
      editorCell.addEditorCell(createNonEmptyProperty_v8czwo_b0());
    }
    return editorCell;
  }
  private EditorCell createComponent_v8czwo_a0() {
  ...
  private EditorCell createNonEmptyProperty_v8czwo_b0() {
