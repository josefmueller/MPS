...
public class BaseTransformationTestJUnitRunnerForPlugin extends BlockJUnit4ClassRunner {
  ...
  public BaseTransformationTestJUnitRunnerForPlugin(Class<?> testClass, MPSProject project) throws InitializationError {
    super(testClass);
    myTestRunner = new TransformationTestRunnerPlugin(project);
  }
