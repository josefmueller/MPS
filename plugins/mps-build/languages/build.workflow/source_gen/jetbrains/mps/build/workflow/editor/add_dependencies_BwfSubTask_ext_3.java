  ...
  public class TMP_Group_cfx569_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class TMP_Action_cfx569_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        add_dependencies_BwfSubTask_ext_3.TMP_Group_cfx569_a0.TMP_Action_cfx569_a0a.Item item = new add_dependencies_BwfSubTask_ext_3.TMP_Group_cfx569_a0.TMP_Action_cfx569_a0a.Item(context);
        String description;
        try {
        ...
        context.getEditorMenuTrace().pushTraceInfo();
        try {
          context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:1267752b-a233-4432-a848-3e68e0ea0db1(jetbrains.mps.build.workflow.editor)", "1741258697587102557")));
