...
public class MigrationDescriptor implements MigrationAspectDescriptor {
  private Map<Integer, MigrationScript> myScripts = MapSequence.<Integer, MigrationScript>fromMapAndKeysArray(new HashMap<Integer, MigrationScript>(), 0, 1, 2, 3).withValues(new BuildJavaVersionMigration(), new BuildJavaVersionMigration_JDKDefault(), new ModuleXml_classpathEntry(), new ModuleResources());
