...
SET USER_VM_OPTIONS_FILE=%USERPROFILE%\.MPS2017.3\mps%BITS%.exe.vmoptions
...
::set ADDITIONAL_JVM_ARGS=-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5061
:: 64 bit
::set ADDITIONAL_JVM_ARGS=-XX:ReservedCodeCacheSize=240m
::set ADDITIONAL_JVM_ARGS=-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5061

set IDEA_PATHS_SELECTOR=MPS2017.3
