...
public class typeof_ContextExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode contextExpression, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:8b43a830-217d-43d8-a0f8-6460c443f22d(jetbrains.mps.execution.configurations.typesystem)", "6250782472215252362", true), (SNode) createClassifierType_wnwgn_a1a2a0a1(), _info_12389875345);
    }
  }
  ...
  private static SNode createClassifierType_wnwgn_a1a2a0a1() {
