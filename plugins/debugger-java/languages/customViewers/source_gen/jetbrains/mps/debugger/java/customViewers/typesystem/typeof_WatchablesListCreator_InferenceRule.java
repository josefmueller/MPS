...
public class typeof_WatchablesListCreator_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode watchablesListCreator, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:3883084c-f018-4330-aab0-6829350c4b17(jetbrains.mps.debugger.java.customViewers.typesystem)", "1842653058275013463", true), (SNode) createWatchableListType_e5m9au_a1a2a0a1(), _info_12389875345);
    }
  }
  ...
  private static SNode createWatchableListType_e5m9au_a1a2a0a1() {
