...
public class TestSubstitute_Subconcepts_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(TestSubstitute_Subconcepts_Test.class, "${mps_home}", "r:62873c84-7a76-488a-9b84-4e0ffdbec8db(jetbrains.mps.lang.editor.menus.substitute.tests.tests@tests)", false);

  public TestSubstitute_Subconcepts_Test() {
    super(ourParamCache);
  }
