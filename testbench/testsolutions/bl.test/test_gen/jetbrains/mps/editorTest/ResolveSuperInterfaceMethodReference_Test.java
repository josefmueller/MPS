...
public class ResolveSuperInterfaceMethodReference_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(ResolveSuperInterfaceMethodReference_Test.class, "${mps_home}", "r:914ee49a-537d-44b2-a5fb-bac87a54743d(jetbrains.mps.editorTest@tests)", false);

  public ResolveSuperInterfaceMethodReference_Test() {
    super(ourParamCache);
  }
