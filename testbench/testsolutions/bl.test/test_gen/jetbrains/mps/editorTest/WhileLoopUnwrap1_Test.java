...
public class WhileLoopUnwrap1_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(WhileLoopUnwrap1_Test.class, "${mps_home}", "r:914ee49a-537d-44b2-a5fb-bac87a54743d(jetbrains.mps.editorTest@tests)", false);
  ...
  public void test_WhileLoopUnwrap1() throws Throwable {
    new WhileLoopUnwrap1_Test.TestBody(this).testMethod();
  }
