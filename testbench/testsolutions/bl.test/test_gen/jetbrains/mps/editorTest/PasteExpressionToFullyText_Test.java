...
public class PasteExpressionToFullyText_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(PasteExpressionToFullyText_Test.class, "${mps_home}", "r:914ee49a-537d-44b2-a5fb-bac87a54743d(jetbrains.mps.editorTest@tests)", false);
  ...
  public void test_PasteExpressionToFullyText() throws Throwable {
    new PasteExpressionToFullyText_Test.TestBody(this).testMethod();
  }
