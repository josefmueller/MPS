...
public class AddStatementToBlock_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(AddStatementToBlock_Test.class, "${mps_home}", "r:914ee49a-537d-44b2-a5fb-bac87a54743d(jetbrains.mps.editorTest@tests)", false);
  ...
  public void test_AddStatementToBlock() throws Throwable {
    new AddStatementToBlock_Test.TestBody(this).testMethod();
  }
