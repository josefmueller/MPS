...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
  ...
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    ...
    switch (index_xbvbvu_a0a.index(cncpt_a0a)) {
      ...
      case 7:
        return Collections.<ConceptEditor>singletonList(new TestSubstituteConceptToWrapFromTransformMenu_Editor());
      case 8:
      ...
      case 1:
        if (true) {
          switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0a0b1a4, menuId.getFqName())) {
            ...
            case 1:
              return Arrays.asList(new TransformationMenu[]{new TestSubstituteParent_TransformationMenuPart_WrapDefaultSubstituteMenu()});
            case 2:
              return Arrays.asList(new TransformationMenu[]{new TestSubstituteParent_TransformationMenuPart_WrapDefaultSubstituteMenuWithFunction()});
            case 3:
              return Arrays.asList(new TransformationMenu[]{new TestSubstituteParent_TransformationMenuPart_WrapNamedSubstituteMenu()});
            default:
          }
        }
        break;
  ...
  public Collection<SubstituteMenu> getDeclaredDefaultSubstituteMenus(SAbstractConcept concept) {
    ...
    switch (index_xbvbvu_a0f.index(cncpt_a0f)) {
      ...
      case 7:
        return Collections.<SubstituteMenu>singletonList(new TestSubstituteConceptToWrapFromSubstituteMenu_SubstituteMenu());
      case 8:
        return Collections.<SubstituteMenu>singletonList(new TestSubstituteConceptToWrapFromTransformMenu_SubstituteMenu());
      case 9:
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a0b1a4 = new String[]{"jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor.NamedTransformationMenu_EmptyCell", "jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor.TestSubstituteParent_TransformationMenuPart_WrapDefaultSubstituteMenu", "jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor.TestSubstituteParent_TransformationMenuPart_WrapDefaultSubstituteMenuWithFunction", "jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor.TestSubstituteParent_TransformationMenuPart_WrapNamedSubstituteMenu"};
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a0c1a6 = new String[]{"jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor.NamedSubstituteMenuToWrapFromSubstituteMenu"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0d1a6 = new String[]{"jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor.NamedSubstituteMenuToWrapFromTransformMenu"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0e1a6 = new String[]{"jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor.TestSubstituteSubChildSmartReference_SmartReference"};
}
