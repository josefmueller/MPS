...
public class NamedMenu extends TransformationMenuBase {
  ...
  private class TMP_Action_qsw3kc_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      NamedMenu.TMP_Action_qsw3kc_a0.Item item = new NamedMenu.TMP_Action_qsw3kc_a0.Item(context);
      String description;
      try {
  ...
  private class TMP_Action_qsw3kc_c0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    @Nullable
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      NamedMenu.TMP_Action_qsw3kc_c0.Item item = new NamedMenu.TMP_Action_qsw3kc_c0.Item(context);
      String description;
      try {
        description = "single item: " + item.getLabelText("");
      } catch (Throwable t) {
