...
public class TestAssistant_Duplication_ChildIncludeDefaultAndNullMenu_TransformationMenu extends TransformationMenuBase {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.CONTEXT_ASSISTANT).contains(_context.getMenuLocation())) {
      result.add(new TestAssistant_Duplication_ChildIncludeDefaultAndNullMenu_TransformationMenu.TMP_Action_477np9_a0());
    }
    return result;
  }

  private class TMP_Action_477np9_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    @Nullable
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      return new TestAssistant_Duplication_ChildIncludeDefaultAndNullMenu_TransformationMenu.TMP_Action_477np9_a0.Item(context);
    }
