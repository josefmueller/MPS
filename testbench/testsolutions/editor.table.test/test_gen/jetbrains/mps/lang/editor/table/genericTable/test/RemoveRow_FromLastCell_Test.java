...
public class RemoveRow_FromLastCell_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(RemoveRow_FromLastCell_Test.class, "${mps_home}", "r:e02ee75b-0624-4ff2-b4d9-d2277a157ff4(jetbrains.mps.lang.editor.table.genericTable.test@tests)", false);
  ...
  public void test_RemoveRow_FromLastCell() throws Throwable {
    new RemoveRow_FromLastCell_Test.TestBody(this).testMethod();
  }
