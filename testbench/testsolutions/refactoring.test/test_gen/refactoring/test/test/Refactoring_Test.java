...
public class Refactoring_Test extends EnvironmentAwareTestCase {
  ...
  public void test_moveClassWithoutParticipants() throws Exception {
    runCommand(new Runnable() {
      public void run() {
        ...
        Assert.assertTrue(eq_hy6ey0_a0a31a0a0a0a0f(SetSequence.fromSetWithValues(new HashSet<SReference>(), CollectionSequence.fromCollection(sourceModelErrors).ofType(UnresolvedReferenceReportItem.class).select(new ISelector<UnresolvedReferenceReportItem, SReference>() {
  ...
  private static boolean eq_hy6ey0_a0a31a0a0a0a0f(Object a, Object b) {
