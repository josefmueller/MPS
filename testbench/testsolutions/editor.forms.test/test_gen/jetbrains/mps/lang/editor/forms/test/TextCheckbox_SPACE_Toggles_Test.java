...
public class TextCheckbox_SPACE_Toggles_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(TextCheckbox_SPACE_Toggles_Test.class, "${mps_home}", "r:9dd38274-05d8-45ba-a41e-44ac52909443(jetbrains.mps.lang.editor.forms.test@tests)", false);
  ...
  public void test_TextCheckbox_SPACE_Toggles() throws Throwable {
    new TextCheckbox_SPACE_Toggles_Test.TestBody(this).testMethod();
  }
