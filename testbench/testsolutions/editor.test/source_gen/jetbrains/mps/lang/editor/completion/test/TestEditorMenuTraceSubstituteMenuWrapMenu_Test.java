...
public class TestEditorMenuTraceSubstituteMenuWrapMenu_Test extends BaseTransformationTest {
  ...
  public void test_TestEditorMenuTraceSubstituteMenuWrapMenu() throws Throwable {
    ...
    runTest("jetbrains.mps.lang.editor.completion.test.TestEditorMenuTraceSubstituteMenuWrapMenu_Test$TestBody", "testMethod", false);
  }
    ...
    public void testMethodImpl() throws Exception {
      ...
      getEditorComponent().getEditorContext().getRepository().getModelAccess().runReadAction(new Runnable() {
        public void run() {
          ...
          editorMenuTraceInfo = editorMenuTraceInfo.getParent();
          EditorMenuTraceTestUtil.checkTraceInfo(editorMenuTraceInfo, Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(SNodeOperations.getNode("r:12055fd0-2d7f-4ac3-93ec-28bb09579a63(jetbrains.mps.lang.editor.editorTest.editor)", "913276302143897423"), MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x1bc2c2df999a7727L, 0x5c03050cab44f64L, "parts")), MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x5cc5669cafd1be9bL, "jetbrains.mps.lang.editor.structure.SubstituteMenuPart_Wrapper"))).first().getReference());
