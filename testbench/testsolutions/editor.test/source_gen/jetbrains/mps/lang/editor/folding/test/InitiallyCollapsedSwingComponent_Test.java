...
public class InitiallyCollapsedSwingComponent_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(InitiallyCollapsedSwingComponent_Test.class, "${mps_home}", "r:0204c664-b836-4137-bb87-42caecd8a4e3(jetbrains.mps.lang.editor.folding.test)", false);
  ...
  public void test_InitiallyCollapsedSwingComponent() throws Throwable {
    runTest("jetbrains.mps.lang.editor.folding.test.InitiallyCollapsedSwingComponent_Test$TestBody", "testMethod", false);
  }
  ...
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      initEditorComponent("3824034168925550283", "");
