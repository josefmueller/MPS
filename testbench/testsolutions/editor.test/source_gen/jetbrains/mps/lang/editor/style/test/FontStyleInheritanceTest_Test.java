  ...
  public static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      ...
      ModelAccess.instance().runReadAction(new Runnable() {
        public void run() {
          Assert.assertEquals("URW Chancery L", getEditorComponent().findNodeCell(SNodeOperations.cast(getNodeById("8545423393708669280"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xa936c42ccb2c4d64L, 0xa1dc12986579a998L, "jetbrains.mps.lang.editor.styleTests"), 0x38990895c164873aL, "LeafNode")))).getStyle().get(StyleAttributes.FONT_FAMILY));
          ...
          Assert.assertEquals("URW Chancery L", getEditorComponent().findNodeCell(SNodeOperations.cast(getNodeById("8545423393708641683"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xa936c42ccb2c4d64L, 0xa1dc12986579a998L, "jetbrains.mps.lang.editor.styleTests"), 0x38990895c164873aL, "LeafNode")))).getStyle().get(StyleAttributes.FONT_FAMILY));
          ...
          Assert.assertEquals("Ubuntu", getEditorComponent().findNodeCell(SNodeOperations.cast(getNodeById("8545423393708745749"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xa936c42ccb2c4d64L, 0xa1dc12986579a998L, "jetbrains.mps.lang.editor.styleTests"), 0x38990895c164873aL, "LeafNode")))).getStyle().get(StyleAttributes.FONT_FAMILY));
