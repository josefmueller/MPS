      ...
      EditorUtil.runWithTwoStepDeletion(new EditorUtil.EditorTestRunnable() {
        public void run() throws Exception {
          ...
          getEditorComponent().getEditorContext().getRepository().getModelAccess().runReadAction(new Runnable() {
            public void run() {
              Assert.assertTrue(DeletionApproverUtil.isApprovedForDeletion(getEditorComponent().getEditorContext(), SNodeOperations.cast(getNodeById("1241246198931557743"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x81f0abb8d71e4d13L, 0xa0c1d2291fbb28b7L, "jetbrains.mps.lang.editor.editorTest"), 0x29e25dc0d024c706L, "TwoStepDeleteDefaultChildContainer")))));
            }
          });
          invokeAction("jetbrains.mps.ide.editor.actions.Delete_Action");
        }
