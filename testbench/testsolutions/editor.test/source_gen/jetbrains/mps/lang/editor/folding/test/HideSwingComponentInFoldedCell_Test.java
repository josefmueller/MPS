...
public class HideSwingComponentInFoldedCell_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(HideSwingComponentInFoldedCell_Test.class, "${mps_home}", "r:0204c664-b836-4137-bb87-42caecd8a4e3(jetbrains.mps.lang.editor.folding.test)", false);

  public HideSwingComponentInFoldedCell_Test() {
    super(ourParamCache);
  }
