...
/**
 * 
 * @deprecated It's unlikely you can make use of this class. If you need an Environment instance, check EnvironmentAware. To deal with project modules, just do it yourself. To clone a project, use ProjectCloneSupport.
 */
@Deprecated
