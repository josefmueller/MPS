...
public class typeof_IsNotEmptyOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
        ...
        if (matches_rn73y2_a0a) {
          {
            ...
            typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1219443359861", true), (SNode) _quotation_createNode_30ohwl_a1a2a0a0a2a1a0a1(), _info_12389875345);
          }
        } else {
          {
  ...
  private static SNode _quotation_createNode_30ohwl_a1a2a0a0a2a1a0a1() {
