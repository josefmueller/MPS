...
/*package*/ class ForEachStatement_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_kov3ab_a_0();
  }

  private EditorCell createCollection_kov3ab_a_0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_kov3ab_a_0");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createConstant_kov3ab_a0());
    editorCell.addEditorCell(createConstant_kov3ab_b0());
    editorCell.addEditorCell(createRefNode_kov3ab_c0());
    return editorCell;
  }
  private EditorCell createConstant_kov3ab_a0() {
  ...
  private EditorCell createConstant_kov3ab_b0() {
  ...
  private EditorCell createRefNode_kov3ab_c0() {
