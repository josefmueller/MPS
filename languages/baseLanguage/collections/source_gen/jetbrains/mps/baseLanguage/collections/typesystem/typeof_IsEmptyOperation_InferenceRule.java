...
public class typeof_IsEmptyOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
        ...
        if (matches_sezqyh_a1a) {
          {
            ...
            typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1219443376599", true), (SNode) _quotation_createNode_23wedg_a1a2a0a0a2a1a1a1(), _info_12389875345);
          }
        } else {
          {
  ...
  private static SNode _quotation_createNode_23wedg_a1a2a0a0a2a1a1a1() {
