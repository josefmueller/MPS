...
/*package*/ class MapInitializer_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_3hyu43_a();
  }

  private EditorCell createCollection_3hyu43_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_3hyu43_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createConstant_3hyu43_a0());
    editorCell.addEditorCell(createRefNodeList_3hyu43_b0());
    editorCell.addEditorCell(createConstant_3hyu43_c0());
    return editorCell;
  }
  private EditorCell createConstant_3hyu43_a0() {
  ...
  private EditorCell createRefNodeList_3hyu43_b0() {
    ...
    public void installElementCellActions(SNode elementNode, EditorCell elementCell) {
      if (elementCell.getUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET) == null) {
        ...
        if (elementCell.getSubstituteInfo() == null || elementCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
          elementCell.setSubstituteInfo(new SChildSubstituteInfo(elementCell, getNode(), MetaAdapterFactory.getContainmentLink(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, 0x118f2481867L, 0x118f24be244L, "entries"), elementNode));
        }
      }
    }
    @Override
  ...
  private EditorCell createConstant_3hyu43_c0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
