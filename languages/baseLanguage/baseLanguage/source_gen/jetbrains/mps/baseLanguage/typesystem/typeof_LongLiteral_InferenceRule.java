...
public class typeof_LongLiteral_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode literal, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "4269842503726244055", true), (SNode) _quotation_createNode_one0gd_a1a2a0a1(), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_one0gd_a1a2a0a1() {
