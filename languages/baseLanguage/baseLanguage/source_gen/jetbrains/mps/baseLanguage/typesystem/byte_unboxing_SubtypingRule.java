...
public class byte_unboxing_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public SNode getSubOrSuperType(SNode byteType, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    return _quotation_createNode_1sray5_a0a2();
  }
  ...
  public IsApplicableStatus isApplicableAndPattern(SNode argument) {
    {
      GeneratedMatchingPattern pattern = new Pattern_1sray5_a0a0a0e(_quotation_createNode_1sray5_a0a0a0a0e());
  ...
  private static SNode _quotation_createNode_1sray5_a0a2() {
  ...
  private static SNode _quotation_createNode_1sray5_a0a0a0a0e() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
