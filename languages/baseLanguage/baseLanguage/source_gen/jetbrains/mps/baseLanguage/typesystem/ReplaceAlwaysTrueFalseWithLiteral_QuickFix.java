...
public class ReplaceAlwaysTrueFalseWithLiteral_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    SNodeOperations.replaceWithAnother(node, _quotation_createNode_7hp7vs_a0a0a2(((Boolean) ReplaceAlwaysTrueFalseWithLiteral_QuickFix.this.getField("value")[0]).toString()));
  }
  private static SNode _quotation_createNode_7hp7vs_a0a0a2(Object parameter_1) {
