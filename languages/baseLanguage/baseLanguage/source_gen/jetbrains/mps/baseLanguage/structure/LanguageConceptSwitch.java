...
public final class LanguageConceptSwitch {
  ...
  public static final int LongLiteral = 172;
  public static final int LongType = 173;
  public static final int LoopLabel = 174;
  public static final int LoopLabelReference = 175;
  public static final int LowerBoundType = 176;
  public static final int MethodDeclaration = 177;
  public static final int MinusAssignmentExpression = 178;
  public static final int MinusExpression = 179;
  public static final int Modifier = 180;
  public static final int MulAssignmentExpression = 181;
  public static final int MulExpression = 182;
  public static final int NPEEqualsExpression = 183;
  public static final int NPENotEqualsExpression = 184;
  public static final int NestedNewExpression = 185;
  public static final int NotEqualsExpression = 186;
  public static final int NotExpression = 187;
  public static final int NullLiteral = 188;
  public static final int NullType = 189;
  public static final int Number = 190;
  public static final int OperationAssignmentExpression = 191;
  public static final int OrAssignmentExpression = 192;
  public static final int OrExpression = 193;
  public static final int ParameterDeclaration = 194;
  public static final int ParenthesizedExpression = 195;
  public static final int PlaceholderMember = 196;
  public static final int PlusAssignmentExpression = 197;
  public static final int PlusExpression = 198;
  public static final int PostfixDecrementExpression = 199;
  public static final int PostfixIncrementExpression = 200;
  public static final int PrefixDecrementExpression = 201;
  public static final int PrefixIncrementExpression = 202;
  public static final int PrimitiveClassExpression = 203;
  public static final int PrimitiveType = 204;
  public static final int PrivateVisibility = 205;
  public static final int Property = 206;
  public static final int PropertyImplementation = 207;
  public static final int PropertyReference = 208;
  public static final int PropertyValueReference = 209;
  public static final int ProtectedVisibility = 210;
  public static final int PublicVisibility = 211;
  public static final int QualifiedSuperMethodCall = 212;
  public static final int RemAssignmentExpression = 213;
  public static final int RemExpression = 214;
  public static final int RemarkStatement = 215;
  public static final int ReturnStatement = 216;
  public static final int RightShiftAssignmentExpression = 217;
  public static final int SetAccessor = 218;
  public static final int ShiftLeftExpression = 219;
  public static final int ShiftRightExpression = 220;
  public static final int ShiftRightUnsignedExpression = 221;
  public static final int ShortType = 222;
  public static final int SingleLineComment = 223;
  public static final int Statement = 224;
  public static final int StatementCommentPart = 225;
  public static final int StatementList = 226;
  public static final int StaticFieldDeclaration = 227;
  public static final int StaticFieldReference = 228;
  public static final int StaticInitializer = 229;
  public static final int StaticKind = 230;
  public static final int StaticMethodCall = 231;
  public static final int StaticMethodDeclaration = 232;
  public static final int StringBooleanOperation = 233;
  public static final int StringLiteral = 234;
  public static final int StringToken = 235;
  public static final int StringType = 236;
  public static final int StubStatementList = 237;
  public static final int SubstringExpression = 238;
  public static final int SuperConstructorInvocation = 239;
  public static final int SuperConstructorKind = 240;
  public static final int SuperInerfaceKind = 241;
  public static final int SuperMethodCall = 242;
  public static final int SuperMethodKind = 243;
  public static final int SwitchCase = 244;
  public static final int SwitchStatement = 245;
  public static final int SynchronizedStatement = 246;
  public static final int TernaryOperatorExpression = 247;
  public static final int TextCommentPart = 248;
  public static final int ThisConstructorInvocation = 249;
  public static final int ThisConstructorKind = 250;
  public static final int ThisExpression = 251;
  public static final int ThrowStatement = 252;
  public static final int Tokens = 253;
  public static final int TrimOperation = 254;
  public static final int TryCatchStatement = 255;
  public static final int TryStatement = 256;
  public static final int Type = 257;
  public static final int TypeAnnotable = 258;
  public static final int TypeDerivable = 259;
  public static final int TypeVariableDeclaration = 260;
  public static final int TypeVariableReference = 261;
  public static final int UnaryMinus = 262;
  public static final int UndefinedType = 263;
  public static final int UnknownConsCall = 264;
  public static final int UnknownDotCall = 265;
  public static final int UnknownLocalCall = 266;
  public static final int UnknownNameRef = 267;
  public static final int UnknownNew = 268;
  public static final int UnresolvedNameReference = 269;
  public static final int UnsignedRightShiftAssignmentExpression = 270;
  public static final int UpperBoundType = 271;
  public static final int UsingStatement = 272;
  public static final int ValueParameter = 273;
  public static final int VarType = 274;
  public static final int VariableArityType = 275;
  public static final int VariableDeclaration = 276;
  public static final int VariableReference = 277;
  public static final int Visibility = 278;
  public static final int VoidType = 279;
  public static final int WhileStatement = 280;
  public static final int WildCardType = 281;
  public static final int XorAssignmentExpression = 282;
