...
public class BinaryOperation_Alias_TransformationMenu extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("named transformation menu " + "BinaryOperation_Alias_TransformationMenu", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "8577426829558646394")));
    try {
  ...
  public class TMP_IncludeSM_wto20o_a0 extends IncludeSubstituteMenuTransformationMenuPart {
    ...
    protected SubstituteMenuLookup getSubstituteMenuLookup(TransformationMenuContext context) {
      ...
      return new NamedSubstituteMenuLookup(LanguageRegistry.getInstance(editorContext.getRepository()), conceptToFindMenuFor, "jetbrains.mps.baseLanguage.editor.BinaryOperation_Alias_SubstituteMenu");
    }
