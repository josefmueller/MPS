...
/*package*/ class ForeachStatement_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_j22tlf_a_0();
  }

  private EditorCell createCollection_j22tlf_a_0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_j22tlf_a_0");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createConstant_j22tlf_a0());
    editorCell.addEditorCell(createConstant_j22tlf_b0());
    editorCell.addEditorCell(createRefNode_j22tlf_c0());
    return editorCell;
  }
  private EditorCell createConstant_j22tlf_a0() {
  ...
  private EditorCell createConstant_j22tlf_b0() {
  ...
  private EditorCell createRefNode_j22tlf_c0() {
