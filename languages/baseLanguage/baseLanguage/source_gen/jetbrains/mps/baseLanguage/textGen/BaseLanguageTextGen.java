...
public abstract class BaseLanguageTextGen {
  ...
  protected static Tuples._2<String, String> getPackageAndShortName(SReference classifierRef, final TextGenContext ctx) {
    ...
    if (reference instanceof DynamicReference) {
      ...
      if (targetNode == null) {
        tgs.reportError("Target node is null for reference to classifier with role " + check_v9xqql_a0a0a0a0a0b0a5a41(SLinkOperations.getRefLink(classifierRef)) + "; resolve info " + SLinkOperations.getResolveInfo(classifierRef) + "; " + jetbrains.mps.util.SNodeOperations.getDebugText(classifierRef.getSourceNode()));
        return null;
      }
  ...
  private static String check_v9xqql_a0a0a0a0a0b0a5a41(SReferenceLink checkedDotOperand) {
