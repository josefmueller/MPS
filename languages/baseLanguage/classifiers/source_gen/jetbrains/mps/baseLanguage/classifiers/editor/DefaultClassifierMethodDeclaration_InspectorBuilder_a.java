...
/*package*/ class DefaultClassifierMethodDeclaration_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_77c6be_a_0();
  }

  private EditorCell createCollection_77c6be_a_0() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_77c6be_a_0");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createConstant_77c6be_a0());
    editorCell.addEditorCell(createRefNodeList_77c6be_b0());
    return editorCell;
  }
  private EditorCell createConstant_77c6be_a0() {
  ...
  private EditorCell createRefNodeList_77c6be_b0() {
