...
public class typeOf_Node_GetAncestorOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode op, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    RulesUtil.equate_conceptFromOpParm(typeCheckingContext, op, typeCheckingContext.getRepresentative(ConceptFromOpParm_typevar_1207354629107));
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1207354639036", true), (SNode) _quotation_createNode_acw35t_a1a2a2a1(typeCheckingContext.getRepresentative(ConceptFromOpParm_typevar_1207354629107)), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_acw35t_a1a2a2a1(Object parameter_1) {
