...
/*package*/ class LinkAttributeQualifier_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_mg3hvm_a0() {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), provider.getCellContext(), new SubstituteInfoPartExt[]{new LinkAttributeQualifier_EditorBuilder_a.LinkAttributeQualifier_attributeConcept_cellMenu_mg3hvm_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  private static class linkQualifierSingleRoleHandler_mg3hvm_c0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new SChildSubstituteInfo(editorCell, myNode, MetaAdapterFactory.getContainmentLink(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x58ea5217b045b9b7L, 0x58ea5217b045be92L, "linkQualifier"), child));
      }
      if (editorCell.getRole() == null) {
