...
public class typeof_ModelReferenceExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode modelRef, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "559557797393151935", true), (SNode) _quotation_createNode_siar27_a1a2a0a1(), _info_12389875345);
    }
    if ((SLinkOperations.getTarget(modelRef, MetaAdapterFactory.getContainmentLink(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, 0x7c3f2da20e92b62L, 0x13bfe1ec0ddbc5f8L, "repo")) != null)) {
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1423104411233529827", true), (SNode) createClassifierType_siar27_a1a2a0a1a1(), _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_siar27_a1a2a0a1() {
  ...
  private static SNode createClassifierType_siar27_a1a2a0a1a1() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
