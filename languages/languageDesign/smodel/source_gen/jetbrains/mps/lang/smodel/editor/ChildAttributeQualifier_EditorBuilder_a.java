...
/*package*/ class ChildAttributeQualifier_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_tfkws1_a0() {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), provider.getCellContext(), new SubstituteInfoPartExt[]{new ChildAttributeQualifier_EditorBuilder_a.ChildAttributeQualifier_attributeConcept_cellMenu_tfkws1_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
