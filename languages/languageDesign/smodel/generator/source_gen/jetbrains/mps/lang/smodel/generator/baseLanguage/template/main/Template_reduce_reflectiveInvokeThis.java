  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        SNode callInputNode2 = QueriesGenerated.sourceNodeQuery_a0a0a0a_3(new SourceSubstituteMacroNodeContext(context1, callMacro_f0s0cy_b0a0a1a3a2a4));
        ...
        try {
          environment.resolve(new RefResolver(tnode4, myAssociationLinks[2], context1, new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3099391750892251396"), "BaseConcept") {
            ...
            public Object resolve() {
              return QueriesGenerated.referenceMacro_GetReferent_a0b0a0a_1(createQueryContext());
            }
          });
        } finally {
        }
      ...
      }
      {
        ...
        try {
          ...
          TemplateContext context3 = context1.subContext();
          {
            ...
            try {
              SNodeAccessUtil.setProperty(tnode6, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0a2a0a0_1(new PropertyMacroContext(context3, "foo", propertyMacro_f0s0cy_c0a0c0a0b0d0b0f0c0e))));
            } finally {
            }
          ...
          }
          {
            ...
            if (QueriesGenerated.ifMacro_Condition_a1b2a0a0_1(new IfMacroContext(context3, ifMacroRef_f0s0cy_b0a0b0e0b0f0c0e))) {
              ...
              try {
                environment.resolve(new RefResolver(tnode8, myAssociationLinks[2], context3, new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3099391750892236464"), "BaseConcept") {
                  @Override
                  public Object resolve() {
                    return QueriesGenerated.referenceMacro_GetReferent_a0b2a0a0_1(createQueryContext());
                  }
                });
              } finally {
              }
          ...
          }
          {
            ...
            try {
              SNodeAccessUtil.setProperty(tnode11, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0c2a0a0_1(new PropertyMacroContext(context3, "1234567890", propertyMacro_f0s0cy_c0a0c0a0b0f0b0f0c0e))));
            } finally {
            }
