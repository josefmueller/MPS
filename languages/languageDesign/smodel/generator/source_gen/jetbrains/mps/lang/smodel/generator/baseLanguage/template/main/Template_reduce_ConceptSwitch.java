...
public class Template_reduce_ConceptSwitch extends TemplateDeclarationBase {
    ...
    try {
      TemplateContext context1 = context.subContext();
      {
        ...
        try {
          ...
          SNodeAccessUtil.setProperty(tnode3, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0a0a1a_1(new PropertyMacroContext(context2, "cncpt", propertyMacro_j8e1z8_c0a0c0b0d0b0c0f))));
          ...
          }
          {
            ...
            final SNode copySrcInput5 = QueriesGenerated.sourceNodeQuery_a0a0a0b0(new SourceSubstituteMacroNodeContext(context3, copySrcMacro_j8e1z8_b0a0c0e0d0b0c0f));
  ...
  protected Collection<SNode> applyPart1(@NotNull final TemplateContext context) throws GenerationException {
    ...
    if (QueriesGenerated.ifMacro_Condition_a1b0b0(new IfMacroContext(context, ifMacroRef_j8e1z8_b0a0c0g))) {
          ...
          for (SNode itnode6 : loopList6) {
            ...
            try {
              TemplateContext context4 = context3.subContext();
              {
                ...
                try {
                  SNodeAccessUtil.setProperty(tnode8, myProperties[1], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0a0b0b0(new PropertyMacroContext(context4, "0", propertyMacro_j8e1z8_c0a0c0a0b0b0e0d0c0b0c0g))));
                } finally {
                }
              ...
              }
              {
                ...
                try {
                  TemplateContext context5 = context4.subContext();
                  {
                    ...
                    if (QueriesGenerated.ifMacro_Condition_a0a0a1a1a(new IfMacroContext(context5, ifMacroRef_j8e1z8_b0a0b0b0b0c0e0d0c0b0c0g))) {
