...
public class Template_reduce_ConceptSwitch extends TemplateDeclarationBase {
    ...
    try {
      TemplateContext context1 = context.subContext();
      {
        ...
        try {
          ...
          SNodeAccessUtil.setProperty(tnode3, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0a0a1a_1(new PropertyMacroContext(context2, "cncpt", propertyMacro_j8e1z8_c0a0c0b0d0b0c0e))));
          ...
          }
          {
            ...
            final SNode copySrcInput5 = QueriesGenerated.sourceNodeQuery_a0a0a0b0(new SourceSubstituteMacroNodeContext(context3, copySrcMacro_j8e1z8_b0a0c0e0d0b0c0e));
  ...
  protected Collection<SNode> applyPart1(@NotNull final TemplateContext context) throws GenerationException {
    ...
    if (QueriesGenerated.ifMacro_Condition_a1b0b0(new IfMacroContext(context, ifMacroRef_j8e1z8_b0a0c0f))) {
      ...
      try {
        ...
        }
        {
          ...
          final Iterable<SNode> loopList6 = QueriesGenerated.sourceNodesQuery_a0a1a1a(new SourceSubstituteMacroNodesContext(context1, loopMacroRef_j8e1z8_b0a0a1a2a1a2a5));
          int loopIndex_i_6 = 0;
          for (SNode itnode6 : loopList6) {
            ...
            try {
              TemplateContext context4 = context3.subContext();
              {
                ...
                try {
                  SNodeAccessUtil.setProperty(tnode8, myProperties[1], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0a0b0b0(new PropertyMacroContext(context4, "0", propertyMacro_j8e1z8_c0a0c0a0b0b0e0d0c0b0c0f))));
                } finally {
                }
              ...
              }
              {
                ...
                try {
                  TemplateContext context5 = context4.subContext();
                  {
                    ...
                    if (QueriesGenerated.ifMacro_Condition_a0a0a1a1a(new IfMacroContext(context5, ifMacroRef_j8e1z8_b0a0b0b0b0c0e0d0c0b0c0f))) {
                      Collection<SNode> tlist11 = null;
                      final Iterable<SNode> copyListInput11 = QueriesGenerated.sourceNodesQuery_a1a0a1a1a(new SourceSubstituteMacroNodesContext(context5, copySrcListMacro_j8e1z8_b0a0a1a1a1a1a2a4a3a2a1a2a5));
              ...
              try {
                environment.resolve(new RefResolver(tnode18, myAssociationLinks[2], context6, new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "4454796803413438135"), "index") {
                  ...
                  public Object resolve() {
                    return QueriesGenerated.referenceMacro_GetReferent_a0a0b0b0(createQueryContext());
                  }
                });
              } finally {
              }
