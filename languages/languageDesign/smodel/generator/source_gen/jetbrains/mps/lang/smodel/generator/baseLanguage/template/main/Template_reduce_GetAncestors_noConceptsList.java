  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_a0a0_8(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_mxkg5_b0a0c0d0c0f));
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode6, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0c0_9(new PropertyMacroContext(context1, null, propertyMacro_mxkg5_c0a0c0a0b0f0c0f))));
        } finally {
        }
