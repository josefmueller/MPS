...
public class Template_reduce_GetAllSiblingsOperation extends TemplateDeclarationBase {
  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_a0a0_3(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_qcgeyz_b0a0c0d0c0e));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_qcgeyz_b0a0c0d0c0e, "tpl/r:00000000-0000-4000-0000-011c89590303/1145573721936", context1);
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode4, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0b0_5(new PropertyMacroContext(context1, null, propertyMacro_qcgeyz_c0a0c0a0b0e0c0e))));
        } finally {
        }
  ...
  private static SNodePointer copySrcMacro_qcgeyz_b0a0c0d0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1145573721937");
  private static SNodePointer propertyMacro_qcgeyz_c0a0c0a0b0e0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1145573721939");
}
