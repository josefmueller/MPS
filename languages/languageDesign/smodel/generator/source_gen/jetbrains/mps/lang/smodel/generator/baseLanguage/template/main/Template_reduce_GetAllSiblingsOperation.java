  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_a0a0_3(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_qcgeyz_b0a0c0d0c0f));
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode4, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0b0_5(new PropertyMacroContext(context1, null, propertyMacro_qcgeyz_c0a0c0a0b0e0c0f))));
        } finally {
        }
