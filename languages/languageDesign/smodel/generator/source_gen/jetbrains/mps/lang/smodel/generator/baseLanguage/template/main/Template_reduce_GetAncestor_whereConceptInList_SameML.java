...
public class Template_reduce_GetAncestor_whereConceptInList_SameML extends TemplateDeclarationBase {
  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_2111762137401170982(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_nv63xn_b0a0c0d0c0e));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_nv63xn_b0a0c0d0c0e, "tpl/r:00000000-0000-4000-0000-011c89590303/2111762137401170980", context1);
          ...
          TemplateContext context2 = context1.subContext();
          {
            ...
            try {
              ...
              }
              {
                ...
                final Iterable<SNode> loopList7 = QueriesGenerated.sourceNodesQuery_3902354333653806871(new SourceSubstituteMacroNodesContext(context3, loopMacroRef_nv63xn_b0a0a1a2a1a1a1a4a2a4));
                for (SNode itnode7 : loopList7) {
                  ...
                  SNode callInputNode8 = QueriesGenerated.sourceNodeQuery_3902354333653818152(new SourceSubstituteMacroNodeContext(context4, includeMacro_nv63xn_b0a0a3a2a2a1a1a1a4a2a4));
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode10, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_2111762137401171006(new PropertyMacroContext(context1, null, propertyMacro_nv63xn_c0a0c0a0b0f0c0e))));
        } finally {
        }
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode11, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_2111762137401171015(new PropertyMacroContext(context1, null, propertyMacro_nv63xn_c0a0c0a0b0g0c0e))));
        } finally {
        }
  ...
  private static SNodePointer copySrcMacro_nv63xn_b0a0c0d0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2111762137401170981");
  private static SNodePointer loopMacroRef_nv63xn_b0a0a1a2a1a1a1a4a2a4 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3902354333653806869");
  private static SNodePointer includeMacro_nv63xn_b0a0a3a2a2a1a1a1a4a2a4 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3902354333653814673");
  private static SNodePointer propertyMacro_nv63xn_c0a0c0a0b0f0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2111762137401171005");
  private static SNodePointer propertyMacro_nv63xn_c0a0c0a0b0g0c0e = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2111762137401171014");
}
