...
public class Switch_switch_ILinkQualifier_toSLink extends TemplateSwitchBase implements TemplateSwitchMapping {
  ...
  public final class ReductionRule0 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      final SNode copySrcInput1 = QueriesGenerated.ifMacro_Condition_28553929717175739630(new SourceSubstituteMacroNodeContext(context, copySrcMacro_3v20rx_b0a0d0b7));
  ...
  public final class ReductionRule1 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      final TemplateExecutionEnvironment environment = context.getEnvironment();
      Collection<SNode> tlist1 = null;
      SNode callInputNode1 = QueriesGenerated.ifMacro_Condition_28553929717175739730(new SourceSubstituteMacroNodeContext(context, includeMacro_3v20rx_b0a0a2a1i));
