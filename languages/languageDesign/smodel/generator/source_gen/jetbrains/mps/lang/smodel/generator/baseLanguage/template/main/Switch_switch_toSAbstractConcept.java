...
public class Switch_switch_toSAbstractConcept extends TemplateSwitchBase implements TemplateSwitchMapping {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      try {
        ...
        TemplateContext context1 = context.subContext();
        {
          ...
          final SNode copySrcInput2 = QueriesGenerated.ifMacro_Condition_66775043232811066830(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_594pev_b0a0c0d0c0b7));
  ...
  public final class ReductionRule1 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      SNode callInputNode1 = QueriesGenerated.ifMacro_Condition_39023543336533593450(new SourceSubstituteMacroNodeContext(context, includeMacro_594pev_b0a0a2a1i));
