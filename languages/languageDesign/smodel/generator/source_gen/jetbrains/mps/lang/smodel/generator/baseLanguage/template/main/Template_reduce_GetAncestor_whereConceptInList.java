...
public class Template_reduce_GetAncestor_whereConceptInList extends TemplateDeclarationBase {
  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_a0a0_6(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_xj3d7b_b0a0c0d0c0e));
          ...
          TemplateContext context2 = context1.subContext();
          {
            ...
            try {
              ...
              }
              {
                ...
                final Iterable<SNode> loopList7 = QueriesGenerated.sourceNodesQuery_a0a0b0(new SourceSubstituteMacroNodesContext(context3, loopMacroRef_xj3d7b_b0a0a1a2a1a1a1a4a2a4));
                for (SNode itnode7 : loopList7) {
                  ...
                  SNode callInputNode8 = QueriesGenerated.sourceNodeQuery_a1a0b0(new SourceSubstituteMacroNodeContext(context4, includeMacro_xj3d7b_b0a0a3a2a2a1a1a1a4a2a4));
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode10, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0c0_7(new PropertyMacroContext(context1, null, propertyMacro_xj3d7b_c0a0c0a0b0f0c0e))));
        } finally {
        }
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode11, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0d0_5(new PropertyMacroContext(context1, null, propertyMacro_xj3d7b_c0a0c0a0b0g0c0e))));
        } finally {
        }
  ...
  private static SNodePointer includeMacro_xj3d7b_b0a0a3a2a2a1a1a1a4a2a4 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3902354333653985492");
