  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_a0a0_6(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_xj3d7b_b0a0c0d0c0f));
            ...
            try {
              ...
              }
              {
                ...
                for (SNode itnode7 : loopList7) {
                  ...
                  SNode callInputNode8 = QueriesGenerated.sourceNodeQuery_a1a0b0(new SourceSubstituteMacroNodeContext(context4, includeMacro_xj3d7b_b0a0a3a2a2a1a1a1a4a2a5));
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode10, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0c0_7(new PropertyMacroContext(context1, null, propertyMacro_xj3d7b_c0a0c0a0b0f0c0f))));
        } finally {
        }
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode11, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0d0_5(new PropertyMacroContext(context1, null, propertyMacro_xj3d7b_c0a0c0a0b0g0c0f))));
        } finally {
        }
