...
public class Switch_switch_IPropertyQualifier_toSProperty extends TemplateSwitchBase implements TemplateSwitchMapping {
  ...
  public final class ReductionRule0 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      final SNode copySrcInput1 = QueriesGenerated.ifMacro_Condition_17576994766914513250(new SourceSubstituteMacroNodeContext(context, copySrcMacro_2s2e5_b0a0d0b7));
  ...
  public final class ReductionRule1 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      final TemplateExecutionEnvironment environment = context.getEnvironment();
      Collection<SNode> tlist1 = null;
      SNode callInputNode1 = QueriesGenerated.ifMacro_Condition_13418609004907704760(new SourceSubstituteMacroNodeContext(context, includeMacro_2s2e5_b0a0a2a1i));
