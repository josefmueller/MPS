...
public class Template_reduce_ConceptMethodCallReflectiveWithSuper extends TemplateDeclarationBase {
  ...
  protected Collection<SNode> applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    if (QueriesGenerated.ifMacro_Condition_a1a0a0(new IfMacroContext(context, ifMacroRef_qqxek3_b0a0c0e))) {
        ...
        TemplateContext context1 = context.subContext();
        {
          ...
          try {
            ...
            }
            {
              ...
              final SNode copySrcInput6 = QueriesGenerated.sourceNodeQuery_a0a0a0a0_3(new SourceSubstituteMacroNodeContext(context2, copySrcMacro_qqxek3_b0a0c0c0b0b0b0c0e));
