...
public class typeof_ConstraintFunctionParameter_referenceNode_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
    ...
    if ((applicableConcept == null)) {
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.lang.constraints.typesystem)", "1212097655292", true), (SNode) _quotation_createNode_57math_a1a2a0a2a1(), _info_12389875345);
      }
    } else {
      {
        SNode _nodeToCheck_1029348928467 = node;
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590309(jetbrains.mps.lang.constraints.typesystem)", "1212097660327", true), (SNode) _quotation_createNode_57math_a1a2a0a0c0b(applicableConcept), _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_57math_a1a2a0a2a1() {
  ...
  private static SNode _quotation_createNode_57math_a1a2a0a0c0b(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
