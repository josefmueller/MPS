...
public class MigrationDescriptor implements MigrationAspectDescriptor {
  private Map<Integer, MigrationScript> myScripts = MapSequence.<Integer, MigrationScript>fromMapAndKeysArray(new HashMap<Integer, MigrationScript>(), 0, 1, 2).withValues(new ConstraintCanBeFunctions_NodeToConcept(), new ConstraintScopeFactory_NodeToConcept(), new AnnotateRefPresentationQueriesAsMigrated());
