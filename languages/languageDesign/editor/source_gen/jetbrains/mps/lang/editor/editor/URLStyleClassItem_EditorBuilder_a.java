...
/*package*/ class URLStyleClassItem_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_hlc629_c0() {
    ...
    editorCell.getStyle().putAll(style);
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), provider.getCellContext(), new SubstituteInfoPartExt[]{new URLStyleClassItem_EditorBuilder_a.URLStyleClassItem_generic_cellMenu_hlc629_a0c0(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  private static class querySingleRoleHandler_hlc629_d0 extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new SChildSubstituteInfo(editorCell, myNode, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x5cb9219482b227f7L, 0x5cb9219482b227f8L, "query"), child));
      }
