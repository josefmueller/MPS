  ...
  /*package*/ void migrate() {
    {
      ...
      Iterable<SNode> cellsWithTagsOrApplySideTransforms = CollectionSequence.fromCollection(CommandUtil.instances(CommandUtil.selectScope(null, context), MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eafb9a39L, "jetbrains.mps.lang.editor.structure.EditorCellModel"), false)).where(new IWhereFilter<SNode>() {
  ...
  private void migrateCell(SNode cell, Map<CellsWithSideTransformMigrationHelper.CellKey, SNode> cellKeyToMenu, Map<SNode, Integer> conceptToCounter) {
    ...
    if (!(isChildCell(cell))) {
      ...
      for (String tag : sideTransformTags) {
        if (Objects.equals(tag, null) || Objects.equals(tag, DEFAULT_TAG_NAME)) {
    ...
    if ((SLinkOperations.getTarget(cell, MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xf9eafb9a39L, 0x10f3514bb7cL, "menuDescriptor")) != null)) {
      ...
      if (Sequence.fromIterable(applySideTransforms).isNotEmpty()) {
        ...
        for (SNode apply : Sequence.fromIterable(applySideTransforms)) {
          ...
          if (tag == null || Objects.equals(tag, "") || Objects.equals(tag, DEFAULT_TAG_NAME)) {
