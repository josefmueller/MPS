...
public class typeof_ConceptFunctionParameter_result_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode result, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode conceptOfResult = SLinkOperations.getTarget(SNodeOperations.getNodeAncestor(result, MetaAdapterFactory.getConcept(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x1136583873dL, "jetbrains.mps.lang.actions.structure.ConceptRightTransformPart"), false, false), MetaAdapterFactory.getReferenceLink(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x1136583873dL, 0x11365853456L, "concept"));
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902a6(jetbrains.mps.lang.actions.typesystem)", "1219184766217", true), (SNode) _quotation_createNode_11uozh_a1a2a1a1(conceptOfResult), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_11uozh_a1a2a1a1(Object parameter_1) {
