...
/*package*/ class SideTransformHintSubstituteActionsBuilder_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_185r4c_a0a() {
    ...
    try {
      final SProperty property = MetaAdapterFactory.getProperty(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x108facec6d2L, 0x11b07b83602L, "side");
  ...
  private EditorCell createRefCell_185r4c_c0a() {
    final SReferenceLink referenceLink = MetaAdapterFactory.getReferenceLink(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x108facec6d2L, 0x108facec6d6L, "applicableConcept");
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new SideTransformHintSubstituteActionsBuilder_EditorBuilder_a.Inline_Builder_185r4c_a2a0(getEditorContext(), getNode(), targetNode).createCell();
          }
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(MetaAdapterFactory.getReferenceLink(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x108facec6d2L, 0x108facec6d6L, "applicableConcept"));
    }
  ...
  private EditorCell createProperty_185r4c_e0a() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = MetaAdapterFactory.getProperty(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x108facec6d2L, 0x1099eb798f9L, "transformTag");
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no transformTag>");
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSPropertyOrNode(myNode, property, CellAction_DeleteNode.DeleteDirection.FORWARD));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSPropertyOrNode(myNode, property, CellAction_DeleteNode.DeleteDirection.BACKWARD));
  ...
  private EditorCell createProperty_185r4c_g0a() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = MetaAdapterFactory.getProperty(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x108facec6d2L, 0x10dd6f37ddfL, "description");
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private static class preconditionSingleRoleHandler_185r4c_b1b1a extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(MetaAdapterFactory.getContainmentLink(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x108facec6d2L, 0x10cd4e11b18L, "precondition"));
      }
    }
    @Override
  ...
  private EditorCell createRefNodeList_185r4c_b4b1a() {
    AbstractCellListHandler handler = new SideTransformHintSubstituteActionsBuilder_EditorBuilder_a.variableListHandler_185r4c_b4b1a(myNode, getEditorContext());
  ...
  private static class variableListHandler_185r4c_b4b1a extends RefNodeListHandler {
    ...
    public variableListHandler_185r4c_b4b1a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return MetaAdapterFactory.getContainmentLink(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x108facec6d2L, 0x1182d1f5f8bL, "variable");
    }
    public SAbstractConcept getChildSConcept() {
      return MetaAdapterFactory.getConcept(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x1182d1a6565L, "jetbrains.mps.lang.actions.structure.SideTransformVariableDeclaration");
    }
  ...
  private static class commonInitializerSingleRoleHandler_185r4c_b6b1a extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(MetaAdapterFactory.getContainmentLink(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x108facec6d2L, 0x1182d38806cL, "commonInitializer"));
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
  ...
  private EditorCell createRefNodeList_185r4c_b9b1a() {
    AbstractCellListHandler handler = new SideTransformHintSubstituteActionsBuilder_EditorBuilder_a.partListHandler_185r4c_b9b1a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
  ...
  private static class partListHandler_185r4c_b9b1a extends RefNodeListHandler {
    ...
    public partListHandler_185r4c_b9b1a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return MetaAdapterFactory.getContainmentLink(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x108facec6d2L, 0x11225076f7dL, "part");
    }
    public SAbstractConcept getChildSConcept() {
      return MetaAdapterFactory.getInterfaceConcept(0xaee9cad2acd44608L, 0xaef20004f6a1cdbdL, 0x743255fa452e1995L, "jetbrains.mps.lang.actions.structure.SideTransformMenuBuilderPart");
    }
    public SNode createNodeToInsert(EditorContext editorContext) {
