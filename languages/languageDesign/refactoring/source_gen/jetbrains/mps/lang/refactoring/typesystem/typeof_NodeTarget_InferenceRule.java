...
public class typeof_NodeTarget_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
    ...
    if ((nodeConcept != null)) {
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.typesystem)", "1817812116820054019", true), (SNode) _quotation_createNode_vg2rij_a1a2a0a1a1(nodeConcept), _info_12389875345);
      }
    } else {
      {
        SNode _nodeToCheck_1029348928467 = nodeTarget;
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590316(jetbrains.mps.lang.refactoring.typesystem)", "1817812116820054031", true), (SNode) _quotation_createNode_vg2rij_a1a2a0a0b0b(), _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_vg2rij_a1a2a0a1a1(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_vg2rij_a1a2a0a0b0b() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
