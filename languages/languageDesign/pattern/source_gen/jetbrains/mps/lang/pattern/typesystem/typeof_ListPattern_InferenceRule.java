...
public class typeof_ListPattern_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode nodeToCheck, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if (parent == null) {
      ...
      SAbstractConcept target = (SAbstractConcept) role.getTargetConcept();
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590343(jetbrains.mps.lang.pattern.typesystem)", "1202491231771", true), (SNode) _quotation_createNode_4l3fn1_a1a2a2a0c0b(SNodeOperations.asNode(target)), _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_4l3fn1_a1a2a2a0c0b(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
