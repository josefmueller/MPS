...
public class typeof_SuperNodeExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
    ...
    if ((boolean) SuperNodeExpression__BehaviorDescriptor.isEnclosingMethodStatic_id4xnLoJyFYX5.invoke(nodeToCheck)) {
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:f7f8a091-d98d-402d-85c4-5f05cb2b8c61(jetbrains.mps.lang.behavior.typesystem)", "5527038142169115307", true), (SNode) _quotation_createNode_ts3rwu_a1a2a0a1a1(superConcept), _info_12389875345);
      }
    } else {
      {
        SNode _nodeToCheck_1029348928467 = nodeToCheck;
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:f7f8a091-d98d-402d-85c4-5f05cb2b8c61(jetbrains.mps.lang.behavior.typesystem)", "1225195239815", true), (SNode) _quotation_createNode_ts3rwu_a1a2a0a0b0b(superConcept), _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_ts3rwu_a1a2a0a1a1(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_ts3rwu_a1a2a0a0b0b(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_2 = null;
