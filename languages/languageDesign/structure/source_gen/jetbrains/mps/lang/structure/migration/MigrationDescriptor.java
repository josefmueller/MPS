...
public class MigrationDescriptor implements MigrationAspectDescriptor {
  private Map<Integer, MigrationScript> myScripts = MapSequence.<Integer, MigrationScript>fromMapAndKeysArray(new HashMap<Integer, MigrationScript>(), 0, 1, 2, 3, 4, 5).withValues(new SetOldConceptIds_Empty(), new SetSIds(), new CopyIconsToResources(), new UseDevkit(), new IntroduceSmartRefAttribute(), new MigrateHelpURL());
