  ...
  public class TMP_Group_zaql1a_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class TMP_Action_zaql1a_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        return new CreateFirstDeclaration_ext_3.TMP_Group_zaql1a_a0.TMP_Action_zaql1a_a0a.Item(context);
      }
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        private Item(TransformationMenuContext context) {
          ...
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587065242")));
    ...
    private class TMP_Param_zaql1a_b0a extends ParameterizedMenuPart<SNode, TransformationMenuItem, TransformationMenuContext> {
      ...
      private class TMP_Action_zaql1a_a1a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
        ...
        @Nullable
        protected TransformationMenuItem createItem(TransformationMenuContext context) {
          return new CreateFirstDeclaration_ext_3.TMP_Group_zaql1a_a0.TMP_Param_zaql1a_b0a.TMP_Action_zaql1a_a1a0.Item(context);
        }
        ...
        private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
          ...
          private Item(TransformationMenuContext context) {
            _context = context;
            _context.getEditorMenuTrace().pushTraceInfo();
            _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587065363")));
            myEditorMenuTraceInfo = _context.getEditorMenuTrace().getTraceInfo();
            context.getEditorMenuTrace().popTraceInfo();
          }
