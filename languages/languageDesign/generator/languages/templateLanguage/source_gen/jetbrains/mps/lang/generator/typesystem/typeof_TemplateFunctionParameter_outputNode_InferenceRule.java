...
public class typeof_TemplateFunctionParameter_outputNode_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode node, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if (SNodeOperations.isInstanceOf(parentMacro, MetaAdapterFactory.getConcept(0xb401a68083254110L, 0x8fd384331ff25befL, 0xfd7f44d616L, "jetbrains.mps.lang.generator.structure.ReferenceMacro"))) {
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902e4(jetbrains.mps.lang.generator.typesystem)", "1227099233435", true), (SNode) _quotation_createNode_fai2pj_a1a2a0a1a1(), _info_12389875345);
      }
      return;
    }
    SNode mapperFunc;
    ...
    if (mapperFunc != null) {
      ...
      //  concept of the wrapped template code 
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902e4(jetbrains.mps.lang.generator.typesystem)", "1225234961710", true), (SNode) _quotation_createNode_fai2pj_a1a2a1a0f0b(SNodeOperations.asNode(SNodeOperations.getConcept(SNodeOperations.getParent(parentMacro)))), _info_12389875345);
      }
    }
  }
  ...
  private static SNode _quotation_createNode_fai2pj_a1a2a0a1a1() {
  ...
  private static SNode _quotation_createNode_fai2pj_a1a2a1a0f0b(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
