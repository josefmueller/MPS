...
/*package*/ class CopySrcNodeMacro_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_jiideg_a();
  }

  private EditorCell createCollection_jiideg_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_jiideg_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    editorCell.addEditorCell(createConstant_jiideg_a0());
    editorCell.addEditorCell(createComponent_jiideg_b0());
    return editorCell;
  }
  private EditorCell createConstant_jiideg_a0() {
  ...
  private EditorCell createComponent_jiideg_b0() {
