...
/*package*/ class ReferenceReductionRule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_93s0ck_b0a() {
    ...
    editorCell.addEditorCell(createConstant_93s0ck_b1a0());
    return editorCell;
  }
  private EditorCell createConstant_93s0ck_a1a0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "further conditions");
  ...
  private EditorCell createConstant_93s0ck_b1a0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_93s0ck_b1a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
