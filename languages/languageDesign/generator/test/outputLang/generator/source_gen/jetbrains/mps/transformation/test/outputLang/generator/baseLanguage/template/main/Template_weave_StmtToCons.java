  ...
  protected SNode applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      TemplateContext context1 = context.subContext();
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode2, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_a0a0a0a(new PropertyMacroContext(context1, "to ctor ", propertyMacro_aa0u9n_c0a0c0a0b0b0c0f))));
        } finally {
        }
