...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase implements EditorHintsProvider {
  private Collection<ConceptEditorHint> myHints = Arrays.<ConceptEditorHint>asList(new ConceptEditorHintImpl("comment", "comment", false, "jetbrains.mps.lang.core.editor.BaseEditorContextHints.comment"), new ConceptEditorHintImpl("reflectiveEditor", "reflectiveEditor", false, "jetbrains.mps.lang.core.editor.BaseEditorContextHints.reflectiveEditor"), new ConceptEditorHintImpl("noReflectiveEditor", "noReflectiveEditor", true, "jetbrains.mps.lang.core.editor.BaseEditorContextHints.noReflectiveEditor"), new ConceptEditorHintImpl("reflectiveEditorForNode", "reflectiveEditorForNode", false, "jetbrains.mps.lang.core.editor.BaseEditorContextHints.reflectiveEditorForNode"), new ConceptEditorHintImpl("noReflectiveEditorForNode", "noReflectiveEditorForNode", true, "jetbrains.mps.lang.core.editor.BaseEditorContextHints.noReflectiveEditorForNode"));
  @NotNull
  ...
  private static final ConceptSwitchIndex index_xbvbvu_a0h = new ConceptSwitchIndexBuilder().put(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x339681b4da4ef1a7L)).seal();
  private static final ConceptSwitchIndex index_xbvbvu_a0i = new ConceptSwitchIndexBuilder().put(MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL), MetaIdFactory.conceptId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x38518aff8a105fd6L)).seal();
