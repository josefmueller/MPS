...
public class ChildAttribute_TransformationMenu extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default transformation menu for " + "ChildAttribute", new SNodePointer("r:00000000-0000-4000-0000-011c89590284(jetbrains.mps.lang.core.editor)", "2508844969616682842")));
    try {
  ...
  public class TMP_WrapSM_3jn55v_a0 extends WrapSubstituteMenuTransformationMenuPart {
    @NotNull
    @Override
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("wrap substitute menu " + "", new SNodePointer("r:00000000-0000-4000-0000-011c89590284(jetbrains.mps.lang.core.editor)", "2508844969616682850")));
      try {
    ...
    private SAbstractConcept getConceptToFindMenuFor(TransformationMenuContext _context) {
      return ChildAttribute__BehaviorDescriptor.getLink_idBpxLfMirzf.invoke(_context.getNode()).getTargetConcept();
    }
    ...
    protected TransformationMenuItem createTransformationItem(final SNode targetNode, final SubstituteMenuItem item, final TransformationMenuContext _context) {
      ...
      return new SubstituteMenuItemAsActionItem(item) {
        ...
        public void execute(@NotNull String pattern) {
          ...
          SNodeOperations.getParent(_context.getNode()).insertChildAfter(ChildAttribute__BehaviorDescriptor.getLink_idBpxLfMirzf.invoke(_context.getNode()), createdNode, _context.getNode());
