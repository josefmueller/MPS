...
public final class IntentionsDescriptor extends AbstractIntentionAspectDescriptor {
    ...
    switch (index_hphjzv_d0f.index(cncpt_d0f)) {
      case 0:
        if (true) {
          ...
          intentions[0] = new Word_AddRemoveLink_Intention_Intention();
        }
        break;
      default:
    }
  ...
  public Collection<IntentionFactory> getAllIntentions() {
    ...
    rv[0] = new Word_AddRemoveLink_Intention_Intention();
    return Arrays.asList(rv);
  }
  private static final ConceptSwitchIndex index_hphjzv_d0f = new ConceptSwitchIndexBuilder().put(MetaIdFactory.conceptId(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x229012ddae35f04L)).seal();
}
