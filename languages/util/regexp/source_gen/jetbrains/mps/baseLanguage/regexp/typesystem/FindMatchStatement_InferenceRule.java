...
public class FindMatchStatement_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode fm, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c89590517(jetbrains.mps.baseLanguage.regexp.typesystem)", "1178179183657", true), (SNode) _quotation_createNode_187nmk_a1a2a0a1(), false, true, _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_187nmk_a1a2a0a1() {
