...
public final class IntentionsDescriptor extends AbstractIntentionAspectDescriptor {
    ...
    switch (index_hphjzv_d0f.index(cncpt_d0f)) {
      case 0:
        if (true) {
          ...
          intentions[0] = new AddOnEntry_Intention();
          intentions[1] = new AddOnExit_Intention();
        }
        break;
      default:
    }
  ...
  public Collection<IntentionFactory> getAllIntentions() {
    ...
    rv[0] = new AddOnEntry_Intention();
    rv[1] = new AddOnExit_Intention();
    return Arrays.asList(rv);
  }
  private static final ConceptSwitchIndex index_hphjzv_d0f = new ConceptSwitchIndexBuilder().put(MetaIdFactory.conceptId(0xc3b0572e7f864ac7L, 0xac44ef15dc8f5c15L, 0x148d06483264e4a6L)).seal();
}
