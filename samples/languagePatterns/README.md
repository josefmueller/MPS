...
the Editor cookbook (https://confluence.jetbrains.com/display/MPSD20172/Editor+cookbook). It implements a simple language for specifying drawing commands (line, rectangle):
