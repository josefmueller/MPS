...
public class typeof_LogicalSimpleMathExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode logicalExpression, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:9e78ab00-457d-4aa2-aec8-f0f0bf086985(jetbrains.mps.samples.Expressions.typesystem)", "2073504467207966014", true), (SNode) createSimpleMathBooleanType_ngq3xd_a1a2a0a1(), _info_12389875345);
    }
    {
  ...
  private static SNode createSimpleMathBooleanType_ngq3xd_a1a2a0a1() {
