...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Object propertyMacro_GetPropertyValue_37717542762390613080(final PropertyMacroContext _context) {
  ...
  public static Object propertyMacro_GetPropertyValue_37717542762390417810(final PropertyMacroContext _context) {
    return _context.createUniqueName(_context.getTemplateValue(), null);
  }
  public static Object propertyMacro_GetPropertyValue_36183248299555252070(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), MetaAdapterFactory.getContainmentLink(0x772f6dcd8c0d48f7L, 0x869c908e036f7c8eL, 0x11d45f8a8b9L, 0x11d45f8a8baL, "attribute"))).findFirst(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SPropertyOperations.getString(it, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")).equals("text");
      }
  ...
  public static Object propertyMacro_GetPropertyValue_37717542762394094210(final PropertyMacroContext _context) {
    return _context.createUniqueName(_context.getTemplateValue(), null);
  }
  public static Object referenceMacro_GetReferent_27014574020198572500(final ReferenceMacroContext _context) {
    return _context.getOutputNodeByInputNodeAndMappingLabel(_context.getNode(), "createComponentMethods");
  }
  public static Object referenceMacro_GetReferent_27014574020198572510(final ReferenceMacroContext _context) {
  ...
  public static boolean ifMacro_Condition_37717542762390444290(final IfMacroContext _context) {
  ...
  public static boolean ifMacro_Condition_36183248299555251840(final IfMacroContext _context) {
    return ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), MetaAdapterFactory.getContainmentLink(0x772f6dcd8c0d48f7L, 0x869c908e036f7c8eL, 0x11d45f8a8b9L, 0x11d45f8a8baL, "attribute"))).any(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SPropertyOperations.getString(it, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")).equals("text");
      }
  ...
  private static class PVQ extends PropertyValueQuery.Base {
    ...
    public Object evaluate(@NotNull PropertyMacroContext ctx) throws GenerationFailureException {
      switch (methodKey) {
        case 0:
          return QueriesGenerated.propertyMacro_GetPropertyValue_37717542762390613080(ctx);
        case 1:
          return QueriesGenerated.propertyMacro_GetPropertyValue_37717542762390417810(ctx);
        case 2:
          return QueriesGenerated.propertyMacro_GetPropertyValue_36183248299555252070(ctx);
        case 3:
          return QueriesGenerated.propertyMacro_GetPropertyValue_37717542762394094210(ctx);
        default:
  ...
  private static class IfMC implements IfMacroCondition {
    ...
    public boolean check(@NotNull IfMacroContext ctx) throws GenerationFailureException {
      switch (methodKey) {
        case 0:
          return QueriesGenerated.ifMacro_Condition_37717542762390444290(ctx);
        case 1:
          return QueriesGenerated.ifMacro_Condition_36183248299555251840(ctx);
        default:
  ...
  private static class RTQ extends ReferenceTargetQuery.Base {
    ...
    public Object evaluate(@NotNull ReferenceMacroContext ctx) throws GenerationFailureException {
      switch (methodKey) {
        case 0:
          return QueriesGenerated.referenceMacro_GetReferent_27014574020198572500(ctx);
        case 1:
          return QueriesGenerated.referenceMacro_GetReferent_27014574020198572510(ctx);
        default:
          throw new GenerationFailureException(String.format("Inconsistent QueriesGenerated: there's no method for query %s (key: #%d)", ctx.getTemplateReference(), methodKey));
      }
    }
