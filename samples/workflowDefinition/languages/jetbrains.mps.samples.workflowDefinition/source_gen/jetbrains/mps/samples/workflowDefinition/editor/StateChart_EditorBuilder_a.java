...
/*package*/ class StateChart_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_4ldurz_a() {
    ...
    editorCell.addEditorCell(createConstant_4ldurz_e0());
    editorCell.addEditorCell(createComponent_4ldurz_f0());
    editorCell.addEditorCell(createConstant_4ldurz_g0());
    editorCell.addEditorCell(createRefCell_4ldurz_h0());
    return editorCell;
  }
  ...
  private EditorCell createComponent_4ldurz_f0() {
  ...
  private EditorCell createRefCell_4ldurz_h0() {
      ...
      protected EditorCell createRefCell(EditorContext context, final SNode effectiveNode, SNode node) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new StateChart_EditorBuilder_a.Inline_Builder_4ldurz_a7a(getEditorContext(), myNode, effectiveNode).createCell();
          }
  ...
  /*package*/ static class Inline_Builder_4ldurz_a7a extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;
    private SNode myReferencingNode;

    /*package*/ Inline_Builder_4ldurz_a7a(@NotNull EditorContext context, SNode referencingNode, @NotNull SNode node) {
      super(context);
    ...
    /*package*/ EditorCell createCell() {
      return createProperty_4ldurz_a0h0();
    }
    ...
    private EditorCell createProperty_4ldurz_a0h0() {
      CellProviderWithRole provider = new PropertyCellProvider(myNode, getEditorContext());
      provider.setRole("name");
      provider.setNoTargetText("<no name>");
