...
<model ref="r:ef9fd842-b350-4ad1-83c7-4b57a2c65330(org.jetbrains.mps.samples.Constants.structure)">
  ...
  <node concept="1TIwiD" id="3tw0l3Pakp_">
    ...
    <node concept="RPilO" id="47y0FrqaLmT" role="lGtFl">
      <ref role="RPilL" node="3tw0l3PakpA" resolve="original" />
    </node>
  </node>
  ...
  <node concept="1TIwiD" id="2lb0lXX3TWw">
    ...
    <node concept="RPilO" id="47y0FrqaLmS" role="lGtFl">
      <ref role="RPilL" node="2lb0lXX5tT2" resolve="clazz" />
    </node>
  </node>
</model>
