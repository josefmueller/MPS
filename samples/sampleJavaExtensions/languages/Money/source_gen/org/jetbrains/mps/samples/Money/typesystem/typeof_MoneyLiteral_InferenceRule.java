...
public class typeof_MoneyLiteral_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode ml, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:0c486cb8-8265-4e9d-90e8-118f83fd1147(org.jetbrains.mps.samples.Money.typesystem)", "5447719361346490737", true), (SNode) _quotation_createNode_1il3t_a1a2a0a1(), false, true, _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_1il3t_a1a2a0a1() {
