...
<model ref="r:d30b7004-00fd-4d3e-bdd6-6ae5346d9b86(jetbrains.mps.samples.lambdaCalculus.structure)">
  ...
  <node concept="1TIwiD" id="3vh6UvnZ_if">
    ...
    <node concept="RPilO" id="47y0FrqaLml" role="lGtFl">
      <ref role="RPilL" node="7M_MU5__DjX" resolve="variable" />
    </node>
  </node>
  ...
  <node concept="1TIwiD" id="4ibC_jHLM5G">
    ...
    <node concept="RPilO" id="47y0FrqaLmk" role="lGtFl">
      <ref role="RPilL" node="7M_MU5__DjW" resolve="variable" />
    </node>
  </node>
