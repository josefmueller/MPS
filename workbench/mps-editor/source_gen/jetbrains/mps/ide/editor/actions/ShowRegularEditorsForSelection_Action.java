...
public class ShowRegularEditorsForSelection_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ReflectiveHintsManager.execute(((List<SNode>) MapSequence.fromMap(_params).get("selectedNodes")), false, true, ((EditorComponent) MapSequence.fromMap(_params).get("editorComponent")));
  }
}
