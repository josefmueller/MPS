...
public class ShowReflectiveEditorsForSubtree_Action extends BaseAction {
  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    ReflectiveEditorActionManager.update(((List<SNode>) MapSequence.fromMap(_params).get("selectedNodes")), true, ((EditorComponent) MapSequence.fromMap(_params).get("editorComponent")), event);
  }
  @Override
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ReflectiveEditorActionManager.execute(((List<SNode>) MapSequence.fromMap(_params).get("selectedNodes")), true, ((EditorComponent) MapSequence.fromMap(_params).get("editorComponent")));
  }
}
