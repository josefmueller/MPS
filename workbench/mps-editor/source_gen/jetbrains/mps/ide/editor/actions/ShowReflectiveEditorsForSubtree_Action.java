...
public class ShowReflectiveEditorsForSubtree_Action extends BaseAction {
  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    ReflectiveHintsManager.update(((List<SNode>) MapSequence.fromMap(_params).get("selectedNodes")), true, true, ((EditorComponent) MapSequence.fromMap(_params).get("editorComponent")), event);
  }
  @Override
