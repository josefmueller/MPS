...
public class ShowRegularEditorByDefault_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ReflectiveHintsForModelComponent.getInstance(event.getData(CommonDataKeys.PROJECT)).showRegularEditorByDefault(event.getData(MPSCommonDataKeys.CONTEXT_MODEL));
  }
}
