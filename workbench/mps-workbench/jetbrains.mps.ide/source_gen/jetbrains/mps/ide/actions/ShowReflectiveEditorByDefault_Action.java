...
public class ShowReflectiveEditorByDefault_Action extends BaseAction {
  private static final Icon ICON = null;

  public ShowReflectiveEditorByDefault_Action() {
    super("Show Reflective Editor by Default", "", ICON);
